...
from NIdaqmx_ScopeFoundry.ni_do_device import NI_DO_device
...
class NI_DO_hw(HardwareComponent):
    ...
    def setup(self):
        ...
        self.channel = self.add_logged_quantity('channel', dtype=str, choices=terminals, initial='Dev2/port1/line0')
